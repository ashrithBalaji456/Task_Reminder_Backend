...
public class TaskMapper {
    ...
    public TaskResponse toTaskResponse(TaskOccurrence occurrence) {
        ...
        return TaskResponse.builder()
                ...
                .repeatFrequencyMinutes(occurrence.getRepeatFrequencyMinutes())
                .repeatStopCondition(occurrence.getRepeatStopCondition())
                .maxReminderCount(occurrence.getMaxReminderCount())
                .reminderSentCount(occurrence.getReminderSentCount())
                .notifyByEmail(occurrence.getNotifyByEmail())
                .notifyByPush(occurrence.getNotifyByPush())
