...
@Component
public class MonthlyReportEmailTemplate {

    private static final DateTimeFormatter DATE_FORMATTER = DateTimeFormatter.ofPattern("MMM dd, yyyy");

    public String buildMonthlyReportHtml(String userName, MonthlyAnalyticsResponse analytics) {
        ...
        return "<html><body style='font-family: Arial, sans-serif; background-color: #f4f6f8; margin: 0; padding: 20px;'>" +
                ...
                "<tr style='background-color: #6f42c1; color: #ffffff;'><td style='padding: 20px; text-align: center;'>" +
                "<h2 style='margin: 0;'>📈 Monthly Productivity Report</h2>" +
                "<p style='margin: 5px 0 0 0; opacity: 0.9; font-size: 14px;'>" + escapeHtml(analytics.getMonthName()) + " (" + periodStr + ")</p>" +
                "</td></tr>" +
                "<tr><td style='padding: 25px;'>" +
                "<p style='font-size: 16px; color: #333;'>Hello <strong>" + escapeHtml(userName) + "</strong>,</p>" +
                "<p style='font-size: 15px; color: #555;'>Here is your comprehensive monthly productivity performance report:</p>" +

                "<div style='text-align: center; background-color: #f8f9fa; padding: 20px; border-radius: 6px; margin: 20px 0; border: 1px solid #e9ecef;'>" +
                "<span style='font-size: 14px; color: #666; text-transform: uppercase; font-weight: bold;'>Monthly Completion Rate</span>" +
                "<div style='font-size: 42px; font-weight: bold; color: #6f42c1; margin: 10px 0;'>" + analytics.getCompletionRate() + "%</div>" +
                ...
                "<div style='margin: 25px 0; padding: 15px; background-color: #fafafa; border-radius: 6px; border-left: 4px solid #6f42c1;'>" +
                "<p style='margin: 5px 0; color: #333; font-size: 14px;'><strong>Best Week:</strong> " + escapeHtml(analytics.getBestWeek()) + "</p>" +
                ...
                "<p style='margin: 5px 0; color: #333; font-size: 14px;'><strong>Medium Priority Completed:</strong> " + analytics.getMediumPriorityCompleted() + " (Pending: " + analytics.getMediumPriorityPending() + ")</p>" +
                "<p style='margin: 5px 0; color: #333; font-size: 14px;'><strong>Low Priority Completed:</strong> " + analytics.getLowPriorityCompleted() + " (Pending: " + analytics.getLowPriorityPending() + ")</p>" +
                "</div>" +

                "<div style='text-align: center; margin-top: 25px;'>" +
                "<h4 style='color: #444; margin-bottom: 10px;'>Monthly Completion Trend</h4>" +
                "<img src='cid:monthly_chart.png' alt='Monthly Completion Chart' style='max-width: 100%; height: auto; border-radius: 6px; border: 1px solid #e0e0e0;' />" +
                "</div>" +

                "</td></tr>" +
                "<tr><td style='background-color: #f8f9fa; padding: 15px; text-align: center; color: #888; font-size: 12px; border-top: 1px solid #eeeeee;'>" +
                "Task Reminder Service &copy; 2026. Excellent month!" +
                "</td></tr>" +
                "</table></body></html>";
    }
